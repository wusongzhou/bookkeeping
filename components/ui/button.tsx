...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2383E2] dark:focus-visible:ring-[#529CCA] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        default:
          'bg-[#2383E2] text-white hover:bg-[#1a73d1] dark:bg-[#529CCA] dark:hover:bg-[#4a8ab8] shadow-sm',
        destructive:
        ...
        secondary:
          'bg-[#E9E9E7] dark:bg-[#3F3F3F] text-[#37352F] dark:text-[#E6E6E6] hover:bg-[#D3D2CF] dark:hover:bg-[#4F4F4F]',
        ghost: 'hover:bg-[#F1F1EF] dark:hover:bg-[#373737] text-[#787774] dark:text-[#9B9A97]',
        link: 'text-[#2383E2] dark:text-[#529CCA] underline-offset-4 hover:underline',
      },
      size: {
